...
public class PostPayloadDAO {
	...
	private String qr_uri_quality_opts;
	...
	public void setQr_uri_quality_opts(String qr_uri_quality_opts) {
		// 
		this.qr_uri_quality_opts = qr_uri_quality_opts;
		
	}
	
	public String getQr_uri_quality_opts() {
		// 
		return this.qr_uri_quality_opts;
